...
abstract contract HederaTokenService {
  ...
  ) internal returns (int256 responseCode, int64 newTotalSupply, int64[] memory serialNumbers) {
    (bool success, bytes memory result) = precompileAddress.call(
  ...
  function getFungibleTokenInfo(
    address token
  ) internal returns (int256 responseCode, IHederaTokenService.FungibleTokenInfo memory tokenInfo) {
    (bool success, bytes memory result) = precompileAddress.call(
  ...
  function getTokenInfo(
    address token
  ) internal returns (int256 responseCode, IHederaTokenService.TokenInfo memory tokenInfo) {
    (bool success, bytes memory result) = precompileAddress.call(
  ...
  function getTokenExpiryInfo(
    address token
  ) internal returns (int256 responseCode, IHederaTokenService.Expiry memory expiryInfo) {
    (bool success, bytes memory result) = precompileAddress.call(
  ...
  ) external returns (int256 responseCode, bytes memory response) {
    (bool success, bytes memory result) = precompileAddress.call(
      abi.encodeWithSelector(
