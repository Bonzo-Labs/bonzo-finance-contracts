...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  DOVU: oneEther.multipliedBy('0.001151').toFixed(),
  HST: oneEther.multipliedBy('0.001151').toFixed(),
  PACK: oneEther.multipliedBy('0.001151').toFixed(),
  STEAM: oneEther.multipliedBy('0.001151').toFixed(),
